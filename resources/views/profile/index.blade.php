...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{url('public/css1/bootstrap.min.css')}}">
    <!-- <link rel="stylesheet" href="{{url('public/css1/unicons.css')}}"> -->
    <link rel="stylesheet" href="{{url('public/css1/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{url('public/css1/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="https://unicons.iconscout.com/release/v2.1.5/css/unicons.css">
    <!-- MAIN STYLE -->
    <link rel="stylesheet" href="{{url('public/css1/tooplate-style.css')}}">
...
-->
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light">
        <div class="container">
            <!-- <a class="navbar-brand" href="{{url('/')}}"><i class='uil uil-user'></i> Marvel</a> -->
            <img width="717" height="300" src="{{url('public/images/epub_logo.png')}}" style="width: 200px;height: 100px;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <!-- <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a href="{{url('loginpage')}}" class="nav-link">Login</a>
                    </li>
                </ul> -->
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-12 col-12 d-flex align-items-center">
                    <div class="about-text">
                        <h1>Almost thousands of books are waiting for you!</h1>
                        <h1>Ready to read?</h1>

                        <p>While others are busy teaching you sky is blue we welcome practical answers that say sky is orange, red, yellow, white, black or grey</p>
                ...
                <div class="col-lg-5 col-md-12 col-12">
                    <div class="about-image svg">
                        <img src="{{url('public/images/111.png')}}" class="img-fluid" alt="svg image">
                    </div>
                </div>
                      ...
                      <div class="owl-carousel owl-theme">
                        <div class="item">
                          <div class="project-info">
                            <img src="{{url('public/images/project/project-image01.png')}}" class="img-fluid" alt="project image">
                          </div>
                        </div>

                        <div class="item">
                          <div class="project-info">
                            <img src="{{url('public/images/project/project-image02.png')}}" class="img-fluid" alt="project image">
                          </div>
                        </div>

                        <div class="item">
                          <div class="project-info">
                            <img src="{{url('public/images/project/project-image03.png')}}" class="img-fluid" alt="project image">
                          </div>
                        </div>

                        <div class="item">
                          <div class="project-info">
                            <img src="{{url('public/images/project/project-image04.png')}}" class="img-fluid" alt="project image">
                          </div>
                        </div>

                        <div class="item">
                          <div class="project-info">
                            <img src="{{url('public/images/project/project-image05.png')}}" class="img-fluid" alt="project image">
                          </div>
                        </div>
                      </div>
    ...
    <script src="{{url('public/js1/jquery-3.3.1.min.js')}}"></script>
    <script src="{{url('public/js1/popper.min.js')}}"></script>
    <script src="{{url('public/js1/bootstrap.min.js')}}"></script>
    <script src="{{url('public/js1/Headroom.js')}}"></script>
    <script src="{{url('public/js1/jQuery.headroom.js')}}"></script>
    <script src="{{url('public/js1/owl.carousel.min.js')}}"></script>
    <script src="{{url('public/js1/smoothscroll.js')}}"></script>
    <script src="{{url('public/js1/custom.js')}}"></script>
