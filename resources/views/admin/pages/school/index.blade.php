        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12 row">
                    ...
                    <div class="col-md-5">
                        <form action="{{url('schoolimport')}}" method="POST" enctype="multipart/form-data" class="d-flex">
                            @csrf
                            <input type="file" name="file" required>
                            &nbsp;&nbsp;<button class="btn btn-primary buttonsize">Import School</button>  
                        </form>
                    </div>

                    <div class="col-md-2">
                        <a href="{{url('schoolimport.xlsx')}}"><button class="btn btn-primary ">Dummy Import</button></a>
                    </div>
                </div>
                                  ...
                                  <td>
                                      <div class="d-flex align-items-center list-action">
                                          <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top"
                                              title="" data-original-title="Edit" href="{{url('admin/updateschool/'.$schools->id)}}"><i
                                          ...
                                          <a onclick="return confirm('Are you sure you want to delete this item?');" class="badge bg-warning mr-2" data-toggle="tooltip" data-placement="top"
                                              title="" data-original-title="Delete" href="{{url('admin/deleteschool/'.$schools->id)}}"><i
