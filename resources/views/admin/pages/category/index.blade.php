            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                        <div>
                            <h4 class="mb-3">Book Category List</h4>
                        </div>
                        <a href="{{url('admin/addCategory')}}" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add
                            Category</a>
                    </div>
                </div>
                <div class="col-lg-12">
                        ...
                        <table class="data-table table mb-0 tbl-server-info">
                            ...
                            <tbody class="ligth-body">
                                ...
                                <tr>
                                  ...
                                  <td>{{$bookcategorys['book_name']}}</td>
                                  <td>
                                      <div class="d-flex align-items-center list-action">
                                          <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top"
                                              title="" data-original-title="Edit" href="{{url('admin/updatebook/'.$bookcategorys->id)}}"><i
                                          ...
                                          <a onclick="return confirm('Are you sure you want to delete this item?');" class="badge bg-warning mr-2" data-toggle="tooltip" data-placement="top"
                                              title="" data-original-title="Delete" href="{{url('admin/deletebook/'.$bookcategorys->id)}}"><i
