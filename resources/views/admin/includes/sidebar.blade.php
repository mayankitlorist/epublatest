  ...
  <div class="data-scrollbar" data-scroll="1">
    <nav class="iq-sidebar-menu">
      <ul id="iq-sidebar-toggle" class="iq-menu">
        ...
        <li class=" ">
          <a href="#tag" class="collapsed" data-toggle="collapse" aria-expanded="false">
            <img src="https://img.icons8.com/external-flatart-icons-outline-flatarticons/64/000000/external-tag-marketing-seo-flatart-icons-outline-flatarticons.png" style="width:25px; height:25px">
          ...
          <ul id="tag" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
            <li class="">
              {{-- <a href="page-list-category.html"> --}}
                
                <a href="{{url('admin/Tag')}}">
                <i class="las la-minus"></i><span>List Tag</span>
              </a>
            </li>
            <li class="">
              {{-- <a href="page-add-category.html"> --}}
                <a href="{{url('admin/addTag')}}">
                <i class="las la-minus"></i><span>Add Tag</span>
              </a>
            </li>
          </ul>
        </li>
